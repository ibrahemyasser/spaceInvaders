...
const unsigned char ZAM[] ={
 ,
};	
	
// *************************** Capture image dimensions out of BMP**********
#define ZAMW        ((unsigned char)ZAM[18])
#define ZAMH        ((unsigned char)ZAM[22])
...
void (*Ptr_to_Fn)(void) = ((void *)0);

void moveUpDown(void);
unsigned char invader_y = 0x0A - 1 ;
int direction = 1;
int main(void){
  ...
  Random_Init(1);
	Timer2_Init(1500,moveUpDown);
  Nokia5110_Init();
  Nokia5110_ClearBuffer();
	Nokia5110_DisplayBuffer();      // draw buffer
	
	//Nokia5110_PrintBMP(33, 24, ZAM, 0); // player ship middle bottom
	
  Nokia5110_PrintBMP(32, 47, PlayerShip0, 0); // player ship middle bottom
  Nokia5110_PrintBMP(33, 47 - PLAYERH, Bunker0, 0);

  Nokia5110_PrintBMP(0, invader_y, SmallEnemy10PointA, 0);
  Nokia5110_PrintBMP(16, invader_y, SmallEnemy20PointA, 0);
  Nokia5110_PrintBMP(32, invader_y, SmallEnemy20PointA, 0);
  Nokia5110_PrintBMP(48,invader_y, SmallEnemy30PointA, 0);
  Nokia5110_PrintBMP(64, invader_y, SmallEnemy30PointA, 0);
  Nokia5110_DisplayBuffer();     // draw buffer
...
void moveUpDown(void)
{
	...
	Nokia5110_ClearBuffer();
	Nokia5110_DisplayBuffer();// draw buffer
		if(invader_y>48)direction=0;
		else if (invader_y == ENEMY10H - 1)direction =1;
		if(direction ==1) invader_y ++;
		else if(direction==0) invader_y--;
	//Nokia5110_PrintBMP(33, 24, ZAM, 0); // player ship middle bottom
 // Nokia5110_PrintBMP(32, 47, PlayerShip0, 0); // player ship middle bottom
  //Nokia5110_PrintBMP(33, 47 - PLAYERH, Bunker0, 0);
...
{
	SYSCTL_RCGC2 |= (1<<PORTF);
	Delay100ms(1);
	GPIOF_LOCK = UNLOCK_VALUE;
	GPIOF_CR = 0x1F;
	GPIOF_AMSEL = 0x0000;
	GPIOF_PCTL = 0x0000;
	GPIOF_DIR  = 0x000E;
...
void GPIOPortF_Handler(void)
{
	...
	else if (GPIOF_RIS  & (1<<4))
	{//s3 pressed
		GPIOF_ICR = 0x10;
		x_pos--;
	}
	Nokia5110_PrintBMP(x_pos, y_pos, ZAM, 0); // player ship middle bottom
	Nokia5110_DisplayBuffer();     // draw buffer
